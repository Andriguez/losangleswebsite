...
<div id="all-posts-container">
    ...
    <div id="btns-container">
        <a type="button" id="text" onclick="displayPostText('general')"><img src="/media/icons/text-icon.svg" alt=""></a>
        <!--<a type="button" id="more" onclick="openPopUp()"><img src="/media/icons/more-icon.svg" alt=""></a>-->
    </div>
</div>


<div class="box-popup" id="box-popup">
    <a id="closing-btn" onclick="closePopUp()"><img src="/media/icons/x-icon.svg"></a>
