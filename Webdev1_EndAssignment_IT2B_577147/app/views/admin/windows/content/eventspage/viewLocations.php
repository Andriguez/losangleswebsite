<div id="view-locations">
    ...
    <div id="button-container">
        <button type="button" class="btn btn-danger" onclick="selectedRadioBtnAction('deletelocation', 'viewlocations')">Delete</button>
        <button class="btn btn-primary" type="button" onclick="selectedRadioBtnOpenWindow('managelocation')">Edit</button>
