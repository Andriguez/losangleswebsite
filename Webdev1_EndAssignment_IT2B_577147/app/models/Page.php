...
{
    private int $page_Id;
    private string $page_title, $page_displayname, $page_url, $page_content_table;
    ...
    public function setContentTable($table){$this->page_content_table = $table;}
    ...
    public function getContentTable():string{return $this->page_content_table;}
